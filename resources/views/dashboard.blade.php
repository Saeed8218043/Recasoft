                        ...
                        <div>
                            ...
                            <div class="m-dropdown m-dropdown--inline m-dropdown--arrow m-dropdown--align-right m-dropdown--align-push"
                                ...
                                <div class="buttons" >
                                        ...
                                        @endif
                                        <button class="btn btn-light detail-page" company_id="{{$row->company_id}}" device_id="{{$equipment->device_id}}" style="border: #bfbfbf 1px solid;">
...
<script>
    $(document).ready(function(){
        $('.detail-page').on('click',function(){
           ...
           let url ='{{url("equipment-details")}}'+'/'+company_id+'/'+device_id;
