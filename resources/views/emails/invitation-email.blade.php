              ...
              <td align="left" style="font-family:OpenSans,&quot;Open Sans&quot;,sans-serif;font-size:14px;vertical-align:top">
                ...
                <tr>
                  <td align="left" style="font-family:OpenSans,&quot;Open Sans&quot;,sans-serif;font-size:14px;vertical-align:top">
                    ...
                    <p style="font-family:OpenSans,&quot;Open Sans&quot;,sans-serif;font-weight:normal;margin:0;font-size:14px;padding:10px 0 10px 0;text-align:center;"><a href="mailto:{{$company_email??''}}" target="_blank">{{$company_email??''}}</a> has invited you to the project {{$company_name??''}}. Log into Recasoft to find this project in your project list.</p>
                  </td>
                </tr>
